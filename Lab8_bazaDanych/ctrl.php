...
getRouter()->setDefaultRoute('loginShow'); // akcja/ścieżka domyślna
...
getRouter()->addRoute('CalcCtrl', 'CalcCtrl',	['user','admin']);
getRouter()->addRoute('CalcProcess', 'CalcCtrl',	['user','admin']);
