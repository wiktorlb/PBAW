...
<form class="pure-form pure-form-stacked" action="{$conf->action_root}calcCompute" method="post">
		<fieldset>
			...
			<input id="percentage" type="text" placeholder="Oprocentowanie" name="percentage" value="{$form->percentage}">

			<label for="length">Długość kredytu</label>
			<input id="length" type="text" placeholder="Długość kredytu" name="length" value="{$form->length}">
		</fieldset>
